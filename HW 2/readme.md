...
A single transmission using blocking communication                  | Execution Time\n
A single transmission using non blocking communication              | Execution Time\n
Two transmissions (round trip) using blocking communication         | Execution Time\n
Two transmissions (round trip) using non blocking communication     | Execution Time\n
